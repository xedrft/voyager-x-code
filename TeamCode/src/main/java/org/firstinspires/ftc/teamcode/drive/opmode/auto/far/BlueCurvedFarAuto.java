...
@Autonomous(name = "Blue 18 Ball Auto (curved)", group = "Autonomous")
@Configurable
public class BlueCurvedFarAuto extends OpMode {
    ...
    private void autonomousUpdate() {
        ...
        switch (pathState) {
            ...
            case 14:
                if (spindexer.isFull()) {
                    ...
                    if (!isSettling) {
                        ...
                        follower.followPath(paths.ShootStray3);
                        setState(15);
                    }
                }
                break;
            ...
            case 16:
                follower.followPath(paths.PickupStray4);
                setState(17);
                break;
            ...
            case 17:
                if (spindexer.isFull()) {
                    ...
                    if (!isSettling) {
                        ...
                        follower.followPath(paths.ShootStray4);
                        setState(18);
                    }
                }
                break;
    ...
    public static class Paths {
        ...
        public PathChain ShootStray3;
        public PathChain PickupStray4;
        public PathChain ShootStray4;
        ...
        public Paths(Follower follower) {
            ...
            ).setLinearHeadingInterpolation(180, 170).build();
            ...
            ).setLinearHeadingInterpolation(170, 180).build();

            PickupStray3 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(40.000, 9.000),
                            new Pose(9.000, 18.000)
                    )
            ).setLinearHeadingInterpolation(180, 160).build();

            ShootStray3 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(9.000, 18.000),
                            new Pose(40.000, 9.000)
                    )
            ).setLinearHeadingInterpolation(160, 180).build();

            PickupStray4 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(40.000, 9.000),
                            new Pose(9.000, 9.000)
                    )
            ).setLinearHeadingInterpolation(180, 180).build();

            ShootStray4 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(9.000, 9.000),
                            new Pose(40.000, 9.000)
                    )
